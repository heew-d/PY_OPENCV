# 0509.py cv2.compareHist(): 1차원 히스토그램 비교
...
print('d1(H1, H2, CORREL)=', d1) #값이 클수록 유사
print('d2(H1, H2, CHISQR)=', d2) #값이 작을수록 유사
print('d3(H1, H2, INTERSECT)=', d3) #값이 클수록 유사
print('d4(H1, H2, BHATTACHARYYA)=', d4) #값이 작을수록 유사
